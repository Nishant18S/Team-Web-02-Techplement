document.addEventListener("DOMContentLoaded",()=>{
    ...
    const categories=[
        {name:"Simple Interest Calculator", img:"assets/img7.svg", content:`<div class="principal">
        ...
        {name:"Compound Interest Calculator", img:"assets/img4.svg", content:`<div class="principal">
            <label for="principal">Principal Amount: </label>
            <input type="text" name="principal" placeholder="Enter Principal">
        </div>
        <div class="rate">
        ...
        {name:"Currency Calculator", img:"assets/img3.svg", content:`<div class="amount">
        ...
        {name:"Salary Calculator", img:"assets/img5.svg", content:`<div class="salary">
        ...
        {name:"Retirement Calculator", img:"assets/img2.svg", content:`<div class="savings">
        ...
        {name:"Sales and Tax Calculator", img:"assets/img6.svg", content:`<div class="beforeTax">
        ...
        {name:"Investment Calculator", img:"assets/img1.svg", content:`
        <div class="principal">
